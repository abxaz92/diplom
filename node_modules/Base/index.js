...
Base.prototype.handle = function (ctx, next) {
	try{ 
        ...
        var width = ctx.query.width;
        var heig = ctx.query.heig;
        var heigh = ctx.query.heigh + 0.1;
        var shir = ctx.query.shir;
        var marka = ctx.query.marka;
        
			  ctx.done(null, Calculate(width, heig, heigh, shir, marka));
	    } else return next();
	} catch(e){
		console.log(e);
	}
